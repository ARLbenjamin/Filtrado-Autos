...
//Agregar un even listener para cunado cargue la pag
...
function noResultados(){
    const C= document.querySelector('#resultado')
    C.innerHTML= `<p></p>`;
    
    const noResultados= document.createElement('div');
    noResultados.classList.add('alerta', 'error');
    noResultados.appendChild(document.createTextNode('No hay Resultado'));
